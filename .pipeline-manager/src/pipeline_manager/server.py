...
def graph_builder_create(
    ...
    Example:
        ...
        graph_builder_save(filename="my-pipeline")
    """
...
def graph_builder_save(
    ...
    """Save the graph to the pipelines library.
    ...
    The file will be saved as {filename}-graph.yaml in the pipelines directory.
    """
    if builder_id not in _graph_builders:
        return {
            "success": False,
    ...
    pipelines_dir = get_global_pipelines_dir()
    ...
    output_path = pipelines_dir / f"{safe_filename}.yaml"
